...
const issues = [
  ...
  },
  {
    ...
    crop: { x: 0.035, y: 0.52, w: 0.93, h: 0.27 },
    callouts: [{
      targets: [{ x: 0.078, y: 0.595, w: 0.845, h: 0.17 }],
      lines: ["Добавить в ведомость отдельную строку «Налог 7%»", "Финальный итог = зарплата + рассчитанный налог"],
    }],
  },
  {
    number: "04",
  ...
  },
  {
    ...
    callouts: [{
      targets: [{ x: 0.078, y: 0.595, w: 0.845, h: 0.17 }],
      lines: ["Для режима 13% добавить строку «НДФЛ −13%»", "Показывать отрицательную сумму и уменьшать итог"],
    }],
  },
  {
    number: "06",
